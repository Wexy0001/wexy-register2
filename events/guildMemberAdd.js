...
\`† A T I A L I T Y #YetkiliAlım'a\` hoş geldin ${member},Bizde Seni Bekliyorduk Sunucumuzun **${member.guild.memberCount}** üyesisin.
        
Hesabın \`(${zaman2})\` önce oluşturulmuş.

Kayıt Olduktan Sonra Sunucu Kurallarımızı Okumayı Unutmayınız Tüm kurallar yazılı değildir, Lütfen kibar olunuz.

Tagımızı \`(${config.registration.GuilDTag})\` alarak bizlere destek olabilirsin.(<a:atalty_hac:997067818531029092> )

Kayıt olmak için \`V.Confirmed\` odalarına girip ses teyit vermen gerekiyor <@&${config.registration.staff}> Rolündeki yetkililerimiz seninle ilgilenecektir.
